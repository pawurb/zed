...
impl Zeta {
    ...
    pub fn debug_info(&mut self) -> mpsc::UnboundedReceiver<ZetaDebugInfo> {
        ...
        let (debug_watch_tx, debug_watch_rx) = channels_console::instrument!((debug_watch_tx, debug_watch_rx), log = true);
...
mod tests {
    ...
    fn init_test(
        ...
        cx.update(move |cx| {
            ...
            #[cfg(feature = "channels-console")]
            let (req_tx, req_rx) = channels_console::instrument!((req_tx, req_rx), log = true);
