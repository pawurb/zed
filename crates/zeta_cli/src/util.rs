...
pub fn wait_for_lang_server(
    ...
    let (mut tx, mut rx) = channels_console::instrument!((tx, rx), capacity = 1, log = true);
    ...
    #[cfg(feature = "channels-console")]
    let (mut added_tx, mut added_rx) = channels_console::instrument!((added_tx, added_rx), capacity = 1, log = true);
